...
var sum = (array, even) => {
 	...
 	switch (even) {
 		case "even": return sumEven; break;
 		case "odd": return sumOdd; break;
 		default: return sumAll; break;
 	}
}
/**;
